...
{
    public partial class datTrabajo : Form
    {
        ...
        private void datTrabajo_Load(object sender, EventArgs e)
        {
            try
            {
                CargarCatalogos();
        ...
        private void dgvPaquetes_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            string sEstado = dgvPaquetes.Rows[e.RowIndex].Cells[15].Value.ToString().Trim();
