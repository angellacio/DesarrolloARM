<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Incidentes.aspx.cs" Inherits="MonitorPaquetesWEB.Incidentes" %>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <asp:Button ID="btnReportes" runat="server" 
                    CssClass="btn btn-primary navbar-btn" Text="Reportes" />
         ...
         <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-warning">
                        <div class="panel-heading">Incidentes "Asigandos" ó "En Curso" sin paquete(s)</div>
                        <div class="panel-body">
                        <asp:GridView ID="GdvIncidentesCurso" 
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">Incidentes "En Curso" con paquete(s)</div>
                        <div class="panel-body">
                        <asp:GridView ID="GdvIncidentesPaquete" 
                                CssClass="table table-striped table-bordered table-hover" runat="server">
                        </asp:GridView>
                        </div>  
                    </div>   
