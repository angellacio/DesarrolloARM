...
using System.Text;
using TagClass.Frames.ID3v2;
using System.Collections;
using TagClass.Frames.ID3v2.ArrayFrames;
using TagClass.Frames.ID3v2.BinaryFrames;
using TagClass.Frames.ID3v2.OtherFrames;
using TagClass.Frames.ID3v2.StreamFrames;
using TagClass.Frames.ID3v2.TextFrames;
