...
using Sat.CreditosFiscales.Procesamiento.PagosV.NegocioPagos;
...
namespace Sat.CreditosFiscales.Procesamiento.PagosV
{
    ...
    /// </summary>
    public class ProcesoPagosV : IDisposable
    {
        ...
        {
            ManejadorArchivos.WriteMessage("->-> Inicia Proceso de Pagos Virtuales.....");

            // POL-8241
            if (InstanciaPrevia())
                return;

            Console.WriteLine("Iniciando Proceso de pagos Virtuales");
 ...
 //               siat.RegistraDetalleVirtual(idProceso, idArchi, lineasApoyo);
       ...
       //             tomar = pagina * ArchivosxZip;
        ...
        private static bool InstanciaPrevia()
        {
            ...
            Process[] processes = Process.GetProcessesByName("Sat.CreditosFiscales.Procesamiento.PagosV");
