...
//@(#)CREDITOSFISCALES(W:71950:Sat.CreditosFiscales.Procesamiento.LogicaNegocio.AccesoLogEventos:Sat.CreditosFiscales.Procesamiento.LogicaNegocio.AccesoLogEventos.LogEventos:1:12/07/2013[Assembly:1.0:12/07/2013])
...
using System.Text;
using Sat.CreditosFiscales.Datos.AccesoDatos.AccesoLogEventos;
using Sat.CreditosFiscales.Comunes.Entidades.AccesoLogEventos;
using System.Data.SqlClient;
using Sat.CreditosFiscales.Comunes.Herramientas;


namespace Sat.CreditosFiscales.Procesamiento.LogicaNegocio.AccesoLogEventos
{
    /// <summary>
    ...
    public static class LogEventos
    {
        ...
        public static string EscribirEntradaLog(int eventoID, string mensaje, EventLogEntryType eventoLogTipo, string aplicacion)
        {
            try
            {
                DalLogEventos dal = new DalLogEventos();
