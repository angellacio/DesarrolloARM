...
namespace SAT.CreditosFiscales.Motor.AccesoDatos.Informacion
{
    ...
    public class DalTransacciones
    {
        ...
        /// <returns></returns>
        public static bool InsertaTransaccion(Guid IdProcesamiento                                              
        ...
        public static bool InsertaTransaccionSIAT(Guid IdProcesamiento, int IdAgrupador, int IdConcepto, string ClaveTransaccion)
        {
            Database db = DatabaseFactory.CreateDatabase();
