...
set nocount on
	...
	insert into tblControlPagosHead (IdProceso, NombreArchivo,IdBanco, FechaPago, NumRegistros, Importe, FechaRegistro, Idestado)
	values(@pIdProceso, @pNombreArchivo, @pIdBanco, @pFechaPago, @pNumRegistros, @pimporte, GETDATE(), 1)
