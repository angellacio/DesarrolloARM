...
namespace SAT.CreditosFiscales.Motor.AccesoDatos.Informacion
{
	...
	public class DalConceptos
	{
		...
		public static string InsertaConceptoOriginal
													(
														Guid idProcesamiento
														, int IdAgrupador
														, string ConceptoOrigen
														, int Ejercicio
														, string PerioricidadOrigen
														, string PeriodoOrigen
														, string FechaCausacion
														, int CreditoSIR
														, decimal IHistorico
														, decimal IParteActualizada
														, decimal IPagar
														, bool Liquidar
														, string MotivoID
														, bool Correcto
		...
		public static string InsertaConceptoHijo(
													Guid IdProcesamiento
													, int IdAgrupador
													, int IdConceptoOriginalPadre
		...
		public static string InsertaConceptoDyP(
													Guid IdProcesamiento
												   , string Clave
												   , int Ejercicio
												   , string ClaveOrigen
		...
		/// <param name="conceptoPadre"></param>
		/// <returns></returns>
