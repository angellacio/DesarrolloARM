...
namespace Sat.Scade.Net.IDE.Presentacion.Web
{
    ...
    ToolboxData(Utility.ToolBoxData.LoginFiel)]
    public class LoginFiel : CompositeControl
    {
        ...
        public string JavaArchive
        {
            get
            {
                ...
                return String.IsNullOrEmpty(s) ? "Recursos/Applet/Internet/AppletFirma.jar" : s;
            }
            set
            {
        ...
        [Category(Utility.Category.EDSFiel), Description("Indica si la liga de CIEC sera mostrada.")]
        public bool CiecVisible
        {
            get
            {
                bool visible = true;
                if (ViewState["CiecVisible"] != null)
                {
                    bool.TryParse((string)ViewState["CiecVisible"], out visible);
                }
                return visible;
            }
            ...
            set
            {
                ViewState["CiecVisible"] = value.ToString();
            }
        }

        [Category(Utility.Category.EDSFiel), Description("Texto que sera mostrado en la liga de CIEC.")]
        public string CiecText
        {
            get
            {
                return (String)ViewState["CiecTextFiel"] ?? Utility.Text.Ciec;
            }
            set
            {
                ViewState["CiecTextFiel"] = value;
            }
        }        
        ...
        [Category(Utility.Category.EDSFiel), Description("Indica si el usuario quiere cambiar el correo electrónico.")]
        public bool MailChecked
        {
            get
            {
                //MGFM 170512
                ICheckBoxControl mailCheckBoxActualiza = (ICheckBoxControl)this.FindControl(Utility.ID.Mail);
                if (mailCheckBoxActualiza != null)
                {
                    return ((CheckBox)this.FindControl(Utility.ID.Mail)).Checked;
                }
                else
                {
                    return false;
        ...
        [Category(Utility.Category.EDSFiel), Description("Indica si sera mostrado el CheckBox de correo electrónico.")]
        public bool MailVisible
        {
            get
            {
                bool visible = true;
                if (ViewState["MailVisible"] != null)
                {
                    bool.TryParse((string)ViewState["MailVisible"], out visible);
                }
                return visible;
            }
            ...
            set
            {
                ViewState["MailVisible"] = value.ToString();
            }
        }
        ...
        [Category(Utility.Category.EDSFiel), Description("Url de correo electrónico que sera usado en caso de que el usuario active el CheckBox de actualizar correo."), UrlProperty, Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        public string MailPageUrl
        {
            get
            {
                String s = (String)ViewState["MailPageUrl"];
                return ((s == null) ? String.Empty : s);
            }

            set
            {
                ViewState["MailPageUrl"] = value;
            }
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            this.CheckBoxUpdateMail = new CheckBox();
            ...
            // R2. Se Crea la Instancia de mailUpdateLink
            this.mailUpdateLink = new HyperLink();

                        
            this.CheckBoxUpdateMail.ID = Utility.ID.Mail;
            ...
            // R2. Establecemos el ID del objeto MailUpdateLink
            this.mailUpdateLink.ID = Utility.ID.MailUpdateLink;
            ...
            if (this.MailVisible)
            {
                this.CheckBoxUpdateMail.Visible = this.MailVisible;
                this.CheckBoxUpdateMail.Text = this.MailText;
                this.CheckBoxUpdateMail.Font.Name = Utility.Style.font_ArialSans;
                this.CheckBoxUpdateMail.Font.Size = sizeFont;
                this.Controls.Add(this.CheckBoxUpdateMail);
            ...
            //MGFM
            this.Controls.Add(new LiteralControl(String.Format("<br/><br/>")));
            this.mailUpdateLink.Text = this.MailText;
            this.mailUpdateLink.NavigateUrl = this.DestinationMailUpdateUrl;
            this.Controls.Add(this.mailUpdateLink);
            //MGFM
            
            if (this.CiecVisible)
            {
                this.Controls.Add(new LiteralControl(String.Format("<br/><br/>")));
                this.CiecLinkButton.Font.Name = Utility.Style.font_ArialSans;
                this.CiecLinkButton.Font.Size = sizeFont;
                this.CiecLinkButton.Text = this.CiecText;
                this.CiecLinkButton.CommandName = Utility.CommandName.LoginTypeFiel;
                this.CiecLinkButton.Command+=new CommandEventHandler(CiecLinkButton_Command);
                this.CiecLinkButton.Visible = this.CiecVisible;
                this.Controls.Add(this.CiecLinkButton); 
            }
            ...
            this.Controls.Add(new LiteralControl("PRUEBA SISTEMAS PARA LA AYUDA."));
        ...
        private string GetRedirectUrl()
        {
            if (this.OnLoginPage())
            {
                if (this.MailChecked)
                {
                    return this.MailPageUrl;
                }
            }

            return base.ResolveClientUrl(this.DestinationPageUrl);
        }
