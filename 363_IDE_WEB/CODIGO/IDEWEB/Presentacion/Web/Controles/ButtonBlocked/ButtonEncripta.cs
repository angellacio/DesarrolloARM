...
namespace Sat.Scade.Net.IDE.Presentacion.Web
{
    ...
    [Themeable(true), ToolboxData(Utility.ToolBoxData.ButtonEncripta)]
    public class ButtonEncripta : Button
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (HabilitarBloqueo)
            {
                this.OnClientClick = String.Format("javascript:return ValidaEncripta();EnviarEncripta()");
            }
        }
