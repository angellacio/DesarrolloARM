<%@ Page Language="C#" MasterPageFile="~/LinGobMX.Master" AutoEventWireup="true"
    CodeBehind="Notificacion.aspx.cs" Inherits="Sat.Scade.Net.IDE.Presentacion.Web.Notificacion"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <asp:LoginStatus ID="satSesionLoginStatus" runat="server" LogoutAction="RedirectToLoginPage"
                        LoginText="Inicio" LogoutText="Inicio" SkinID="LoginStatusScade2" 
                        onloggedout="satSesionLoginStatus_LoggedOut" />
                </li>
                <li>
            ...
            <div class="user-credencials">
                <ul class="list-unstyled" id="LabelRfc">
                    <li>
                        ...
                        <button type="button" class="btn btn-link pull-right" style="text-decoration: underline"
                            id="cSesion" onclick="javascript:__doPostBack('ctl00$ContentPlaceHolder1$satSesionLoginStatus$ctl00','')">
    ...
    <script type="text/javascript">
        ...
        //            try {
        //                document.getElementById('<%=enviarMasHyperLink.ClientID%>').style.visibility = 'hidden';
        ...
        //            try {
        //                document.getElementById('<%=enviarMasHyperLink.ClientID%>').style.visibility = 'visible';
