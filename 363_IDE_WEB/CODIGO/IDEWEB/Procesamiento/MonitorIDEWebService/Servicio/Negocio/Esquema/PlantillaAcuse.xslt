                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                  <tr>
                    <td width="25%">
                      ...
                      <image align="left" height="106" width="130" src="../image/REIMaguila.gif"></image>
                    </td>
      ...
      <tr>
        <td width="100%">
          <table border="0" width="100%">
            ...
            <tr>
              <td>
                <xsl:value-of select="@cadenaOriginal"/>
              </td>
            </tr>
            <tr>
              <td>
      ...
      <tr>
        <td width="1002">
          <table border="0" width="100%">
            ...
            <tr>
              <td>
                Sus datos personales son incorporados y protegidos en los sistemas del SAT, de conformidad
            ...
            <tr>
              <td>
                Si desea modificar o corregir sus datos personales puede acudir a la Administración Desconsentrada de
                Servicios al Contribuyente que le corresponda y/o a través de la dirección www.sat.gob.mx.
              </td>
            </tr>
          </table>
        </td>
            ...
            <tr>
              <td>
                <table border="0" width="100%" cellpadding="0" cellspacing="00">
                  ...
                  <tr>
                    <td colspan="2">
                      <b>Su información fue rechazada por la o las siguientes inconsistencias:</b>
                      <br></br>
                    </td>
                    <td></td>
                    <br></br>
                  ...
                  <tr>
                    <td colspan="2">
                      <b>Realice las correcciones necesarias y vuelva a enviar su Declaración.</b>
                    </td>
                    <td></td>
                    <br></br>
                  </tr>
