...
namespace RecepcionIDEWEB.Negocio.Comun
{
    public static class Mensajes
    {
        ...
        public const string ArchivoExistente = "Ya existe un envío en progreso de este archivo. Si el archivo estaba correcto no lo vuelva a enviar y espere su acuse; en caso contrario genérelo nuevamente y envíelo.";
        ...
        {
            get { return Utilerias.ConsultarArchivoConfiguracion("ErrorMessage"); }
        }
    }
}
