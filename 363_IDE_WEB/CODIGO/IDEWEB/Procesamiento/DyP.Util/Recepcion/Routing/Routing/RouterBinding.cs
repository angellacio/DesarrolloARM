//@(#)SCADE2(W:SKDN08221CO2:SAT.DyP.Routing.Services:RouterBinding:0:21/May/2008[SAT.DyP.Routing.Services:1.0:21/May/2008])
using System;
using System.Xml;
...
namespace SAT.DyP.Routing.Services {
    ...
    public class RouterBinding : Binding, IBindingRuntimePreferences {
        ...
        void Initialize() {
            ...
            // TODO: Sacar esto a configuración.
            base.SendTimeout = new TimeSpan(0, 5, 0);
            base.CloseTimeout = new TimeSpan(0, 5, 0);
            base.OpenTimeout = new TimeSpan(0, 5, 0);
        }
        ...
        protected override ConfigurationPropertyCollection Properties {
            get {
                if (this.properties == null) {
                    ...
                    properties.Add(new ConfigurationProperty("transport", typeof(RouterTransport), RouterTransport.Http, null, null, System.Configuration.ConfigurationPropertyOptions.None));
