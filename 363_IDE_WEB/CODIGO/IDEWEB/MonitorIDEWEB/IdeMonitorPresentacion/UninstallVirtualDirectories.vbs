...
CONST MAXCOM_PORTAL_VD = "IdeMonitorPresentacion"
CONST MAXCOM_APPPOOL_PORTAL = "Scade.Net.IdeMonitorPresentacion"
...
CALL DELETE_VIRTUAL_DIRECTORY ( MAXCOM_PORTAL_VD )

IF (Err.Number <> 0) THEN

      MsgBox "No fue posible ELIMINAR el directorio virtual " & MAXCOM_PORTAL_VD & ". Err: " & Err.Description
      wscript.Quit

END IF

'ELIMINAR EL APP POOL PARA LOS DIRECTORIOS VIRTUALES DE LA APLICACION HTTP DE BIZTALK
CALL DELETE_APP_POOLS( MAXCOM_APPPOOL_PORTAL )
