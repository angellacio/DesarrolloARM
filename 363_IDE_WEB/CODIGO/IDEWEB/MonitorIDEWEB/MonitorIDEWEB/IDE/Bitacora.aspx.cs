...
public partial class IDE_Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ren.Periodo = Periodo.SelectedValue == "0" ? 0 : Int32.Parse(Periodo.SelectedValue);
        ...
        sa = SC.TraerBitacora(ren).ToList();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        TipoArchivo.SelectedIndex = -1;
        //Banco.Text = "";
        UltimoEstado.SelectedIndex = -1;
